      ...
      <section className="px-6 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {EVENTS.map((e, i) => (
              <div key={i} className="group glass rounded-2xl p-6 flex flex-col md:flex-row md:items-center gap-5 hover:bg-blue-500/[0.04] hover:border-blue-500/20 transition-all duration-300">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {PAST.map((p, i) => (
              <div key={i} className="glass rounded-2xl p-6 hover:bg-blue-500/[0.04] transition-colors">
