    ...
    <div ref={ref}>
      ...
      <section ref={parallaxRef} className="relative min-h-screen flex items-start lg:items-center pt-20 pb-12 md:pt-28 md:pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="order-2 lg:order-1 lg:col-span-5">
            {/* University badge */}
            <div data-speed="-0.04" data-animate="fade-right" className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full mb-8 hero-badge">
            ...
            {/* Main headline */}
            <h1 data-speed="-0.025" data-animate="fade-up" data-delay="100"
              className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-black font-display tracking-tight leading-[1.05] mb-4"
              style={{ color: '#E5E7EB' }}>
              Where<br />
            ...
            <div data-animate="fade-up" data-delay="200" className="flex items-center gap-3 mb-6">
              <span className="text-base md:text-lg font-semibold text-slate-400">We are</span>
              <span className="text-base md:text-lg font-black typewriter-word" style={{ color: '#22D3EE' }}>
                {typedText}<span className="typewriter-cursor" />
              </span>
            </div>

            <p data-speed="-0.015" data-animate="fade-up" data-delay="250" className="text-base md:text-lg max-w-lg mb-10 leading-relaxed text-muted">
            ...
            {/* Terminal bar */}
            <div data-animate="fade-up" data-delay="600" className="terminal-bar flex items-center gap-3 px-5 py-3 rounded-xl font-mono text-xs">
          ...
          {/* Right: HeroRobot */}
          <div className="order-1 lg:order-2 lg:col-span-7 relative flex justify-center" data-animate="zoom-in">
            <HeroRobot />
          </div>
        </div>
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10" data-animate="fade-up" data-delay="900">
          ...
          <div className="w-5 h-8 rounded-full border-2 flex justify-center pt-1.5" style={{ borderColor: 'rgba(34,211,238,0.25)' }}>
            <div className="w-1 h-2 rounded-full" style={{ backgroundColor: '#22D3EE', animation: 'scrollDot 2s ease-in-out infinite' }} />
          </div>
        </div>
      </section>
      ...
      <section className="py-28 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          {/* Bento-style grid */}
          <div className="domain-bento-grid">
            {/* Large featured card */}
            {(() => {
              const FeaturedIcon = DOMAINS[0].icon;
              return (
                <div data-animate="fade-up" data-delay="0"
                  className="domain-card domain-card-featured group relative rounded-3xl p-8 overflow-hidden cursor-default"
                  style={{ '--accent': DOMAINS[0].accent, '--glow': DOMAINS[0].glow }}>
                  {/* Animated gradient background */}
                  <div className="domain-card-bg-animated" />
                  {/* Accent top line */}
                  <div className="absolute top-0 left-0 right-0 h-[2px]"
                    style={{ background: `linear-gradient(to right, transparent, ${DOMAINS[0].accent}, transparent)`, opacity: 0.6 }} />

                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-center justify-between mb-6">
                      <div className="icon-box w-16 h-16 shadow-xl"
                        style={{ border: `1px solid ${DOMAINS[0].accent}40`, boxShadow: `0 0 30px ${DOMAINS[0].accent}20` }}>
                        <FeaturedIcon size={28} style={{ color: DOMAINS[0].accent }} />
                      </div>
                      <span className="domain-tag text-[9px] font-bold font-mono px-3 py-1.5 rounded-lg uppercase tracking-wider"
                        style={{ backgroundColor: `${DOMAINS[0].accent}15`, color: DOMAINS[0].accent, border: `1px solid ${DOMAINS[0].accent}30` }}>
                        {DOMAINS[0].tag}
                      </span>
                    </div>
                    <h3 className="text-2xl font-black font-display mb-3 group-hover:text-white transition-colors" style={{ color: '#E5E7EB' }}>
                      {DOMAINS[0].title}
                    </h3>
                    <p className="text-sm leading-relaxed text-muted flex-grow">{DOMAINS[0].desc}</p>
                    <div className="mt-6 flex items-center gap-2 text-sm font-bold" style={{ color: DOMAINS[0].accent }}>
